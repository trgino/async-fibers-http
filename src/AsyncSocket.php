...
use FibersHttp\Exceptions\SocketConnectionTimedOut;
use FibersHttp\Exceptions\SocketEnableCryptoTimeout;
use FibersHttp\Exceptions\SocketEnableCryptoFailed;
use FibersHttp\Exceptions\SocketNotConnected;
use FibersHttp\Exceptions\OpenSSLNotLoaded;
	...
	*/
	...
	public function enableCrypto(): \Fiber{
		...
		return new \Fiber(function(){
			...
			if ($result === 0){
				throw new SocketEnableCryptoTimeout(sprintf("SSL timeout for host %s", $this->host));
			}elseif ($result === false){
